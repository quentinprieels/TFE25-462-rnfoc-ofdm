...
random_seed = 0         # Random seed for reproducibility => THIS MUST BE THE SAME AS IN THE `create_tx.py` FILE!

filename = "signals/rx_samples_schmidl_cox.signal.fc32.dat"  # File to load the received signal
