...
int UHD_SAFE_MAIN(int argc, char* argv[]) {
    ...
    uint32_t sc_threshold = 0, sc_packet_size = 0, sc_output_select = 0, fft_length = 1024 * 4, fft_cp_length = 128;
    ...
    desc.add_options()
        ...
        ("fft_cp_length", po::value<uint32_t>(&fft_cp_length)->default_value(128),   "FFT cyclic prefix length")
    ;
