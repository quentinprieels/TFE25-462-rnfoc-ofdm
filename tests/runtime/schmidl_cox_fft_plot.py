...
results_file = "timing_results_schmidl_cox_fft.csv"
...
common_time = demod_time + channel_est_time
...
# Bar 2 is "equalization", "channel_estimation", "delay_doppler"
bar2 = [
...
plt.tight_layout()
plt.savefig('timing_results_schmidl_cox_fft.pdf')
plt.show()